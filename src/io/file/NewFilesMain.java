...
//        }
        ...
        /**
         * REPLACE_EXISTING: 대상 파일이 이미 존재하면 덮어쓰기(기존 파일을 대체).
         * COPY_ATTRIBUTES: 파일 복사 시 원본 파일의 메타데이터(파일 속성)를 복사.
         * ATOMIC_MOVE: 파일 이동 작업을 원자적(Atomic)으로 수행.
         */
        ...
        //readAttributes(): 파일의 기본 속성들을 한번에 읽기
